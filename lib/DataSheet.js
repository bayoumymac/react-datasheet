  ...
  _createClass(DataSheet, [{
    ...
    value: function handlePaste(e) {
      if (isEmpty(this.state.editing)) {
        ...
        var changes = [];
        var pasteData = !navigator.userAgent.includes("Trident") ? parse(e.clipboardData.getData('text/plain')) : parse(e);
    ...
    value: function handleKey(e) {
      ...
      if (ctrlKeyPressed) {
        if (keyCode === _keys.C_KEY) {
          this.handleCopy(e);
        } else if (keyCode === _keys.V_KEY && navigator.userAgent.includes("Trident")) {
